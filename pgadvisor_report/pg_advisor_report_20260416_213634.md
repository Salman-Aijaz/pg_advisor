...
| `ads` | `user_id` | ❌ critical | `HYPOPG_INDEX_CONFIRMED` | 'ads.user_id' pe index add karne se query cost 22.6% kam ho gi — hypopg se verified. |
...
| `favorites` | `ad_id` | ❌ critical | `HYPOPG_INDEX_CONFIRMED` | 'favorites.ad_id' pe index add karne se query cost 54.4% kam ho gi — hypopg se verified. |
| `favorites` | `user_id` | ❌ critical | `HYPOPG_INDEX_CONFIRMED` | 'favorites.user_id' pe index add karne se query cost 54.4% kam ho gi — hypopg se verified. |
...
| `watch_list` | `user_id` | ❌ critical | `HYPOPG_INDEX_CONFIRMED` | 'watch_list.user_id' pe index add karne se query cost 28.5% kam ho gi — hypopg se verified. |
...
| `watch_list_ad` | `ad_id` | ❌ critical | `HYPOPG_INDEX_CONFIRMED` | 'watch_list_ad.ad_id' pe index add karne se query cost 55.8% kam ho gi — hypopg se verified. |
...
#### ❌ `HYPOPG_INDEX_CONFIRMED``.user_id`

**Severity:** CRITICAL  
**Message:** 'ads.user_id' pe index add karne se query cost 22.6% kam ho gi — hypopg se verified.
...
#### ❌ `HYPOPG_INDEX_CONFIRMED``.ad_id`

**Severity:** CRITICAL  
**Message:** 'favorites.ad_id' pe index add karne se query cost 54.4% kam ho gi — hypopg se verified.
...
**Severity:** CRITICAL  
**Message:** 'favorites.user_id' pe index add karne se query cost 54.4% kam ho gi — hypopg se verified.
...
**Severity:** CRITICAL  
**Message:** 'watch_list.user_id' pe index add karne se query cost 28.5% kam ho gi — hypopg se verified.
...
**Severity:** CRITICAL  
**Message:** 'watch_list_ad.ad_id' pe index add karne se query cost 55.8% kam ho gi — hypopg se verified.
